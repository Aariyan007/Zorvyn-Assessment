// Clean SVG icon set — replaces all emojis across the app
...
export function IconTrendDown({ size = 16, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconArrowUp({ size = 14, color = "currentColor" }) {
  return (
...
export function IconArrowDown({ size = 14, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconEmpty({ size = 40, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 3h18v4H3z" /><path d="M3 7l2 13h14l2-13" />
...
export function CategoryIcon({ category, size = 16, bgColor }) {
  const icons = {
    ...
    Freelance: <><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></>,
    Travel:    <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21 4 19.5 2.5S18 2 16.5 3.5L13 7 4.8 5.2C4.3 5.1 3.9 5.4 3.8 5.9l-.5 2c-.1.5.1 1 .5 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 2.5 5.3c.3.4.8.6 1.3.5l2-.5c.5-.1.8-.5.7-1z" />,
  ...
  const path = icons[category] || icons.Other;

  return (
    <div style={{
      width: size * 2, height: size * 2, borderRadius: 8,
      background: bgColor || "rgba(249,115,22,0.12)",
